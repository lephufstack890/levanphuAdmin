...
@section('wp-content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    <a href="{{url('product/showProduct')}}" class="text-primary">Kích hoạt<span class="text-muted">(<?php echo count($products); ?>)</span></a>
                    ...
                    <tbody>
                        @foreach ($products as $product)
                            <tr class="">
                                ...
                                <td><a href="{{ $product->url = Route('product.seemoreProduct', $product->id) }}">Xem thêm <i class="fas fa-arrow-right"></i></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
