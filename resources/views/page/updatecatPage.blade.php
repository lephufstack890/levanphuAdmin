        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => ['page.storeUpdatecatpage', $page->id], 'method' => 'POST', 'files' => true]) !!}
                            ...
                            <tbody>
                                ...
                                <?php $t++; ?>
                                    <tr>
                                        ...
                                        <td><a href="{{ $cat->url_update = Route('page.updatecatPage', $cat->id) }}" class="btn btn-success btn-sm rounded-0" type="button"
